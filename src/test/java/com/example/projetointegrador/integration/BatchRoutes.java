...
public class BatchRoutes extends BaseTest {
    ...
    void createBatchShouldReturnBatch() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(jsonPath("$.batchProduct[?(@.id == 5)].quantity").value(12))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 5)].manufacturingDate").value("2022-12-10"))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 5)].expirationDate").value("2023-01-01"))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 5)].section.id").value(1))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 5)].remainingQuantity").value(12));
    }
...
//        String responseAsString = objectMapper.writeValueAsString(response);
        ...
        this.mockMvc
                ...
                .andExpect(jsonPath("$.batchProduct[?(@.id == 6)].quantity").value(20))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 6)].manufacturingDate").value("2022-12-23"))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 6)].section.id").value(1))
                .andExpect(jsonPath("$.batchProduct[?(@.id == 6)].remainingQuantity").value(20))
                .andExpect(jsonPath("$.batchProduct", hasSize(5)));
    }
}
